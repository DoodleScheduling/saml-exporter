...
func TestMetrics(t *testing.T) {
	...
	# HELP http_client_requests_total HTTP client request
	# TYPE http_client_requests_total counter
	http_client_requests_total{code="200",host="",method="GET"} 1
	`)))
	...
	# HELP http_client_requests_total HTTP client request
	# TYPE http_client_requests_total counter
	http_client_requests_total{code="0",host="",method="POST"} 1
`)))
}
